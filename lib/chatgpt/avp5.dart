...
class SimpleAVP extends AVP {
  SimpleAVP({
    required DiameterAVPHeader header,
    required Uint8List value,
  }) : super(header: header, value: value);
  ...
  @override
  String toString() {
    return 'SimpleAVP{header: ${header.toString()}, value: ${utf8.decode(value)}}';
  }
}
...
void main() {
  ...
  final avp = SimpleAVP(header: header, value: payload);
